                    ...
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a target="_blank" class="dropdown-item"
                               href="http://docs.bookingcore.org">Documentation</a>
                            <a target="_blank" href="{{config('landing.item_url')}}" class="dropdown-item btn-buynow">BUY
                                NOW</a></li>
                        </div>
                    </div>
                    <ul class="menu">
