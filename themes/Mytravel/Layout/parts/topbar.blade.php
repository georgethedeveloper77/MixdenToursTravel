...
?>
<div
    class="bravo_topbar u-header__hide-content u-header__topbar u-header__topbar-lg border-bottom @if(!empty($is_home)|| !empty($header_transparent))border-color-white @else  border-color-8 @endif">
    <div class="{{$container_class ?? 'container'}}">
        <div class="d-flex align-items-center">
            <div
                class="list-inline u-header__topbar-nav-divider mb-0 topbar_left_text font-size-14 @if(!empty($is_home)|| !empty($header_transparent)) @else  list-inline-dark @endif">
            ...
            <div class="ml-auto d-flex align-items-center">
                ...
                <div
                    class="dropdown-notifications position-relative px-3 u-header__login-form dropdown-connector-xl u-header__topbar-divider">
                    ...
                    @else
                        <div class="d-flex align-items-center text-white py-3 dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-user text-left dropdown">
                                ...
                                @endif
                                <li class=""><a href="{{route('user.booking_history')}}"><i
