                ...
                <div class="row justify-content-xl-between">
                    ...
                    @if($list_widget_footers = setting_item_with_lang("list_widget_footer"))
                        ...
                        @foreach($list_widget_footers as $key=>$item)
                            <div
                                class="col-12 col-md-6 col-lg-{{$item->size ?? '3'}} col-xl-1dot8 mb-6 mb-md-10 mb-xl-0">
                        ...
                        <form action="{{route('newsletter.subscribe')}}"
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append ml-3">
                                    <button type="submit"
                                            class="btn-submit btn btn-sea-green border-radius-3 height-54 min-width-112 font-size-14">{{__('Subscribe')}}
