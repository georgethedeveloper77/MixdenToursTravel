                    ...
                    <div class="p-4">
                        <div class="form-content">
                            ...
                            <div class="form-group">
                                <div
                                    class="guest-wrapper d-flex justify-content-between align-items-center border-bottom border-width-2 border-color-1 pb-3">
                                    <div class="flex-grow-1">
                                        <label>{{__("Start Time")}}</label>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <div class="input-number-group">
                                            <select v-model="start_time" class="form-control form-control-sm"
                                                    @change="startTimeChange()">
                                                @for ( $i = 0 ; $i <= 23 ; $i++)
                                                    <option
                                                        value="{{ sprintf("%02d", $i) }}:00">{{ sprintf("%02d", $i) }} :
                                                        00
                                                    </option>
                                                    <option
                                                        value="{{ sprintf("%02d", $i) }}:30">{{ sprintf("%02d", $i) }} :
                                                        30
                                                    </option>
                                                @endfor
                                            </select>
                            ...
                            <span
                                class="d-block text-gray-1 font-weight-normal mb-0 text-left">{{ __("Select Dates") }}</span>
                            <div class="mb-4">
                                <div class="border-bottom border-width-2 border-color-1 position-relative"
                                    ...
                                    @endif
                                    <small class="alert-text mt10 mt-2" v-show="message2.content"
                                           v-html="message2.content"
                            ...
                            <div class="mb-4 border-bottom border-width-2 border-color-1 pb-1"
                                 v-if="extra_price.length">
