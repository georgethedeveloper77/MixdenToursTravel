                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="rounded-xs mb-5">
                            <a class="d-block" href="{{ $page_search }}">
                                <div
                                    class="bg-img-hero gradient-overlay-half-bg-white transition-3d-hover shadow-hover-2 max-height-200"
                                    style="background-image: url({{asset('/images/space-background.jpg')}});">
                                    <div class="text-center py-5">
                                        ...
                                        <span
                                            class="font-size-14 font-weight-normal text-gray-1">{{ __(':num :text',['num' => count($item->space),'text' => (count($item->space) > 1) ? 'Listings' : 'Listing']) }}</span>
                                    </div>
                                </div>
                            </a>
                        </div>
