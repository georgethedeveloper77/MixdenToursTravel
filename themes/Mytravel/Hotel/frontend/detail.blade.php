                                ...
                                <ul class="ml-n1 list-group list-group-borderless list-group-horizontal custom-social-share">
                                    <li class="list-group-item px-1 py-0">
                                        <div class="service-wishlist {{$row->isWishList()}}" data-id="{{$row->id}}"
                                             data-type="{{$row->type}}">
                                            <span
                                                class="height-45 width-45 border rounded border-width-2 flex-content-center cursor-pointer">
                                    ...
                                    <li class="list-group-item px-1 py-0">
                                        <a id="shareDropdownInvoker{{$row->id}}"
                                           ...
                                           data-unfold-target="#shareDropdown{{$row->id}}"
                                        ...
                                        <div class="flex-horizontal-center ml-2">
                                            ...
                                            <div class="ml-2 text-lh-1">
                                                <div class="ml-1">
                                                    ...
                                                    <span
                                                        class="text-gray-1 font-size-12">({{$review_score['total_review']}} {{ $review_score['total_review'] > 1 ? __('Reviews') : __('Review') }})</span>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="px-2 pt-2">
                                        @if($row->map_lat && $row->map_lng)
                                            <a target="_blank"
                                               ...
                                               class="d-block border rounded mb-4">
                                                <img class="img-fluid" src="{{  url("/images/map.jpg") }}"
                                                     alt="{{__('Address-Description')}}">
                                            </a>
                                            <div class="flex-horizontal-center mb-4">
                                                <div class="border-primary border rounded-xs px-3 text-lh-1dot7 py-1">
                                                    <span
                                                        class="font-size-21 font-weight-bold px-1 mb-0 text-lh-inherit text-primary">@if($review_score) {{$review_score['score_total']}} @endif</span>
                                                </div>
                                                ...
                                                <div class="ml-2 text-lh-1">
                                                    <div class="ml-1">
                                                        ...
                                                        <span
                                                            class="text-gray-1 font-size-14">{{__('Location rating score')}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
