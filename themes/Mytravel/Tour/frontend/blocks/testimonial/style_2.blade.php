    ...
    <div class="bravo-testimonial testimonial-block testimonial-v1">
        <div class="container space-1">
            <div class="pt-7 pb-8">
                ...
                <!-- Slick Carousel -->
                <div class="travel-slick-carousel u-slick u-slick--gutters-3" data-infinite="true" data-autoplay="true"
                        ...
                        <div class="item">
                            ...
                            <div class="d-flex justify-content-center mb-6">
                                <div class="position-relative">
                                    ...
                                    <div
                                        class="btn-position btn btn-icon btn-dark rounded-circle d-flex align-items-center justify-content-center height-60 width-60">
                                        <figure id="quote7" class="" style="">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                 width="30px" height="21px"
                                                 margin-top="20px" class="injected-svg js-svg-injector"
                                                 data-parent="#quote7">
                                                <text kerning="auto" font-family="Lato" fill="rgb(255, 255, 255)"
                                                      font-weight="bold" font-size="70px" x="0px"
                                                      y="51.9180000000001px">“
                                                </text>
                                            </svg>
                                        </figure>
                                    </div>
