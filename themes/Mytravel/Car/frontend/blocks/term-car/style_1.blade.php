            ...
            <div class="row">
                @foreach($terms as $row)
                    <div class="col-md-6 col-xl-3">
                        <div class="mb-5">
                            <a class="d-block position-50-hover text-center overflow-hidden"
                               href="{{ route('car.search',['terms' => $row['id']]) }}">
                                <div class="bg-img-hero rounded-xs bg-gray-23 min-height-200">
                                    ...
                                    <img class="img-fluid position-50-horizontal"
                                         src="{{ get_file_url($row['image_id'],'full') }}" alt="{{$row['name']}}">
                                </div>
                            </a>
                        </div>
                    </div>
