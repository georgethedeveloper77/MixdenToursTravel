                        ...
                        <div class="form-controls">
                            <select name="sms_driver" class="form-control">
                                @foreach(\Modules\Core\SettingClass::UPLOAD_DRIVER as $item=>$value)
                                    <option
                                        value="{{$value}}" {{setting_item('upload_drive') == $value ? 'selected' : ''  }}>{{__(strtoupper($value))}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="admin_country_has_booking" class="form-control">
                            ...
                            @foreach(get_country_lists() as $id=>$name)
                                <option
                                    @if(setting_item_with_lang('admin_country_has_booking',request()->query('lang')) ==$id) selected
