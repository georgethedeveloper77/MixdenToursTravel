        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <textarea name="cancel_policy" class="form-control" rows="5"
                          placeholder="{{ __("Full refund up to 4 days prior.") }}">{{$row->cancel_policy}}</textarea>
            </div>
            <div class="form-group">
                <label>{{__("Additional Terms & Information")}}</label>
                <textarea name="terms_information" class="d-none has-ckeditor" rows="10"
                          placeholder="{{ __("For Sanitary purposes ONLY, although there is a working toilet and shower, we've deactivated the shower and the toliet is for limited use (urine only..pardon the graphic detail!)...") }}">{{$row->terms_information}}</textarea>
            </div>
