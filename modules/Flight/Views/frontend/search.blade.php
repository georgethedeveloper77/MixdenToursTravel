@extends('layouts.app')
@section('head')
    <link href="{{ asset('dist/frontend/module/flight/css/flight.css?_ver='.config('app.asset_version')) }}"
          rel="stylesheet">
...
@section('footer')
    ...
    <script type="text/javascript"
            src="{{ asset('module/flight/js/flight.js?_ver='.config('app.asset_version')) }}"></script>
    <script>
